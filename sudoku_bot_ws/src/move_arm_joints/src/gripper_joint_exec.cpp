...
int main(int argc, char **argv)
{
	...
	ros::NodeHandle nh;
	ros::ServiceServer myServer = nh.advertiseService("move_arm_joints/gripper_joint_service", &recieve_and_send_move);
...
float extract_last_log() {
    ...
    std::ifstream fileRead("gripper_servo_confirm.log");
