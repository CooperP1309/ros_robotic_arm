...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle nh;
    ros::ServiceServer myServer = nh.advertiseService("move_arm_joints/arm_shoulder_lift_joint_service", &recieve_and_send_move);
...
float execute_servo(float move) {
    ...
    std::string cmd = "./arm_shoulder_lift_servo ";
...
float extract_last_log() {
    ...
    std::ifstream fileRead("arm_shoulder_lift_servo_confirm.log");
