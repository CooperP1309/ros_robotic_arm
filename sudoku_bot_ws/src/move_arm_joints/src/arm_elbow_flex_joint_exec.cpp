...
int main(int argc, char **argv)
{
    ...
    ros::init(argc, argv, "arm_elbow_flex_joint_node");
    ros::NodeHandle nh;
    ros::ServiceServer myServer = nh.advertiseService("move_arm_joints/arm_elbow_flex_joint_service", &recieve_and_send_move);
...
float execute_servo(float move) {
    ...
    std::string cmd = "./arm_elbow_flex_servo ";
...
float extract_last_log() {
    ...
    std::ifstream fileRead("arm_elbow_flex_servo_confirm.log");
